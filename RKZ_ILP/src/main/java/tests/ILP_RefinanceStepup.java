...
public class ILP_RefinanceStepup extends QCStore{
	...
	public static void StepUp_A(String SSN,String AppURL) throws Exception{
		...
		{		
			...
			{		
				...
				driver.findElement(By.name("requestBean.siilBean.tenderAmtFirst")).sendKeys(paymentamount2);
						...
						test.log(LogStatus.PASS, "Collateral Type is enterted as :: Cash");
						
						driver.findElement(By.name("requestBean.siilBean.disbAmtFirst")).sendKeys("10");
						test.log(LogStatus.PASS, "Collateral Type is enterted as :: 10");
