...
public class ILP_Refinance_StepSame extends QCStore{
	...
	public static void StepSame(String SSN,String AppURL) throws Exception{
		...
		{		
			...
			{		
				...
				Thread.sleep(3000);
				driver.findElement(By.name("requestBean.siilBean.advAmt")).sendKeys(priciplebalance);
				
				driver.findElement(By.name("requestBean.siilBean.advAmt")).sendKeys(Keys.TAB);
						
						
						
						Thread.sleep(10000);
						String paymentamount2=driver.findElement(By.name("requestBean.siilBean.paymentAmt")).getAttribute("value");
						test.log(LogStatus.PASS, "Getting payment amount "+paymentamount2);		
						Thread.sleep(5000);
					...
					test.log(LogStatus.PASS, "ESign_Password is selected as ::1234");
	...
	public static void StepSame_A(String SSN,String AppURL) throws Exception{
