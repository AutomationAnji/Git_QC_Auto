...
/*String Pname=driver.findElement(By.xpath("//*[@id='riskViewBdy']/table[3]/tbody/tr[1]/td/table/tbody/tr[3]/td/table/tbody/tr["+i+"]/td[2]")).getText();
			...
			if(ESign_CollateralType.equalsIgnoreCase("ACH")){
				...
				driver.findElement(By.name("cardNumber")).sendKeys("1234");
				test.log(LogStatus.PASS, "Card number enterted as 1234");
				
				driver.findElement(By.name("expmonth")).sendKeys("January");
				test.log(LogStatus.PASS, "Month enterted as January");
				
				driver.findElement(By.name("expyear")).sendKeys("2030");
				test.log(LogStatus.PASS, "Year enterted as 2030");	
